...
!isset($_SESSION['role']) ||
   $_SESSION['role'] !== 'admin' || // ensure role is admin
...
<head>
    ...
    <style>
        body {
            ...
            background: url('images/inbg2.jpg') no-repeat center center fixed;
...
<body>
    <div class="container">
        <div class="header" style="display: flex; justify-content: space-between; align-items: center; padding: 10px;">
            ...
            <!-- Logout Button -->
            <a href="logout.php" 
               style="background-color: red; color: white; padding: 10px 20px; text-decoration: none; border-radius: 30px; font-weight: bold; font-size: 22px;">
                Logout
            </a>
        </div>
...
function generatePDFContent(doc, logoData = null) {
    ...
    doc.rect(margin - 5, 10, contentWidth + 10, 25, 'F');
